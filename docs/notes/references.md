...
[Boltzmann distribution](https://en.wikipedia.org/wiki/Boltzmann_distribution#Generalized_Boltzmann_distribution)

### **Ising**
[Ising wiki](https://en.wikipedia.org/wiki/Ising_model)
...
[Hyperspectral Image Analysis Simplified](https://github.com/syamkakarla98/Hyperspectral_Image_Analysis_Simplified)
...
[When to cite ?](https://poorvucenter.yale.edu/undergraduates/using-sources/understanding-and-avoiding-plagiarism/warning-when-you-must-cite)
...
[---> Implementation on NVIDIA's Github](https://github.com/NVIDIA/ising-gpu)
